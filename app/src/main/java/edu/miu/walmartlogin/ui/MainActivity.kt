...
class MainActivity : AppCompatActivity() {
    ...
    val users = mutableListOf(
        User("Usman", "Haider", "usman@miu.com", "123456"),
        User("Muzammil", "Husnain", "muzammil@miu.com", "123456"),
        User("john", "mark", "john@miu.com", "123456"),
        User("adward", "Larry", "adward@miu.com", "123456"),
